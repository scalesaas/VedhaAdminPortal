...
interface NewsFormProps {
  defaultjob: IJobDetial;
  onHandleSubmit: (data: Jobformschematype) => void;
}

export default function NewsForm({ onHandleSubmit, defaultjob }: NewsFormProps) {
  ...
  const form = useForm<Jobformschematype>({
    ...
    defaultValues: {
      ...
      job_link: defaultjob?.job_link || "",
      status: defaultjob?.status || "",
      author: defaultjob?.author || "",
      created_at: defaultjob?.created_at || "",
    },
  });
